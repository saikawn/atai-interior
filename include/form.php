...
$toemails[] = array(
	'email' => 'saikawn@gmail.com', // Your Email Address
	'name' => 'Sai Kwan' // Your Name
);
...
$fromemail = array(
	'email' => 'no-reply@ataiids.com', // Company's Email Address (preferably currently used Domain Name)
	'name' => 'ATAi IDS' // Company Name
);
